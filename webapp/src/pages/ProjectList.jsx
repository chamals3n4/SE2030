          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-lg font-semibold text-gray-900">
                Construction Management System - SE2030
              </h1>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3
                        className="font-semibold text-gray-900 text-lg mb-2 cursor-pointer group-hover:text-blue-600 transition-colors duration-200 line-clamp-2"
                        onClick={() =>
                  ...
                  <div className="flex gap-2 pt-4 border-t border-gray-100">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 text-sm h-9 border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 font-medium bg-transparent"
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-9 w-9 p-0 border-gray-200 text-gray-600 hover:bg-gray-50 hover:border-gray-300 bg-transparent"
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-9 w-9 p-0 border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 bg-transparent"
                      onClick={(e) => {
                        e.stopPropagation();
